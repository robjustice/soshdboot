...
%LD65% obj/sos/sosldr.o obj/sos/init.o obj/sos/sysglob.o obj/sos/bfm.init2.o obj/sos/bfm.o obj/sos/oprmsg.o obj/sos/ipl.o obj/sos/umgr.o obj/sos/Problock3Kernel.o obj/sos/syserr.o obj/sos/devmgr.o obj/sos/scmgr.o obj/sos/fmgr.o obj/sos/cfmgr.o obj/sos/bufmgr.o obj/sos/memmgr.o obj/sos/padding.o -o bin/SOS.KERNEL#0C0000 -C build/apple3.cfg
...
%LD65% obj/rom/diskio.o obj/rom/saratests.o obj/rom/monitor.o -o bin/apple3.rom -C build/apple3.cfg
goto :EOF
...
java -jar %AC% -g %DISK% SOS.DRIVER > bin/SOS.DRIVER#0c0000
1>nul %PYTHON% %A3DUTIL% update obj/disk3/disk3.o65 bin/SOS.DRIVER#0c0000
java -jar %AC% -d %DISK% SOS.DRIVER
java -jar %AC% -p %DISK% SOS.DRIVER SOS $0000 < bin/SOS.DRIVER#0c0000
java -jar %AC% -g %TDMDISK% SOS.DRIVER > bin/SOS.DRIVER_TDM#0c0000
...
%LD65% obj/boot/bootloader_sos.o -o bin/bootloader_1blk.bin -C build/apple3.cfg
%CA65% src/boot/bootloader_sos_tdm.s -l lst/boot/bootloader_sos_tdm.lst -o obj/boot/bootloader_sos_tdm.o
%LD65% obj/boot/bootloader_sos_tdm.o -o bin/bootloader_tdm_1blk.bin -C build/apple3.cfg

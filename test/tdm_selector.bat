rem test selector_tdm_hd.po image
rem
...
%MAMEPATH%\mame apple3 -rompath %MAMEPATH%\roms -bios 1 -skip_gameinfo -resolution 640x480 -window -nothrottle -sl1 cffa2 -hard1 ..\disks\sos_selector_tdm_hd.po -sl2 softcard3
